        ...
        return (
            <section className="form-page">
                <div className="form-container">
                    <img className="form-container__logo"src={logo}/>
                    ...
                    <form className="form">
                        <div className="form__inputs">
                            <div className={`${this.props.nameStatus ? "form__input-name" : "form__input-name_disabled"}`}>
                                ...
                                <input className={`form__name-input form__input`} type="text" id="name" name="name" placeholder="Виталий"/>
                                <label className="form__name-input-label"></label>
                            </div>
                            
                            <p className="form__input-label-text">E-mail</p>
                            <input className="form__email-input form__input" type="email" id="email" name="email" placeholder="pochta@yandex.ru"/>
                            <label className="form__email-input-label"></label>

                            <p className="form__input-label-text">Пароль</p>
                            <input className="form__password-input form__input" type="password" id="password" name="password" placeholder="* * * * * * * * *"/>
                            <label className="form__password-input-label"></label>
                            <p className="form__password-error">Что-то пошло не так</p>
                        </div>

                        <div className="form__button-container">
                            <button className="form__button" type="button">{this.props.textButton}</button>
                        </div>
